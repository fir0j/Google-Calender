...
export const CreateDialog = React.forwardRef(({ dialogStatus, setDialogStatus }, calendarComponentRef) => {
	...
	const addEvent = (eventTitle, eventDate, e) => {
		e.preventDefault();
	...
	const CreateEventDialog = () => {
		return (
			<div className="ml-4 text-xs text-gray-800">
				...
				<p className="mb-2">
					<span className="inline-block border w-32 p-1 mr-2">
						<input
							className="w-full border-gray-500 border-b-2 focus:border-transparent focus:border-blue-600 focus:outline-none text-sm text-gray-600"
